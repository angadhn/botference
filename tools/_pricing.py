...
Single source of truth — imported by botference_agent.py and scripts/usage_report.py.
"""
...
PRICING = {
    # Anthropic
    "claude-fable-5-1":  {"input": 10.0, "output": 50.0, "cache_read": 0.25, "cache_create": 12.5},
